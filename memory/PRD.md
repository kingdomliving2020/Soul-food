...
- [ ] **NEXT (Clarity pass, copy/labels only, no redesign):** #5 Format terminology site-wide (Workbook=Print/POD · Digital Workbook=fillable · eLesson=online lesson · eBook=ePub; retire customer-facing iPDF/i-PDF/ePub), #6 Curriculum→Format→Extras labeling + reduce Featured/Instant-Access duplication.
