...
- ⚠️ **PENDING DECISION:** Breakfast "Offline Game Master" game-pack covers (BM1/BM2/BM3 + overview) received — physical, ships next week. Awaiting user direction on how to surface in Quick Order game store (new tiles vs image swap). iPDF format still gated ("Coming Soon") in the general workbook/snackpack dropdowns — separate go-live decision.
