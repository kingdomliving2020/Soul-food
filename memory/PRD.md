...
- ⚠️ **PENDING DECISION:** Breakfast "Offline Game Master" game packs (BM1/BM2/BM3 + overview covers received). User confirmed: **pre-order**, customer selects **PDF or physical (physical + S&H)** at checkout. Still need tile structure (1 tile w/ module selector vs 3 tiles) + per-module/bundle pricing before building.
