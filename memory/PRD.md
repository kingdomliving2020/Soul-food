...
- ⚠️ **PENDING:** Game-pack **digital PDF files not yet uploaded** — PDF format is pre-order; digital delivery will be pending until user uploads BM1/BM2/BM3 game PDFs (attach to `offline-game-master-bkft-<module>-all-digital`). Physical ships next week.
