              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-4">
                  <p className="text-blue-900 font-semibold flex items-center">
                    ...
                    <span>Paperback Delivery: Ships in 5–10 business days · rates vary by region</span>
                  </p>
                  <p className="text-sm text-blue-700 mt-1 ml-8">
                    US delivery typically 5–10 business days from order (timing depends on shipping option selected)
                  </p>
                </div>
              </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-10">
            ...
            <p className="text-xl text-slate-700 max-w-2xl mx-auto">
              Interactive lessons, eBooks & digital downloads available now. Print workbooks ship within 5–10 business days — rates vary by region
            </p>
          </div>
