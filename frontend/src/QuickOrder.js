  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8">
        ...
        {/* Featured Widgets - Holiday & Free Lesson side by side */}
        <section className="mb-10">
          <div className="grid md:grid-cols-2 gap-6">
            {/* Holiday Special Widget */}
            <Card className="bg-gradient-to-br from-red-50 to-green-50 border-2 border-red-200 shadow-lg hover:shadow-xl transition-shadow overflow-hidden">
              <CardContent className="p-0">
                <div className="flex flex-col sm:flex-row">
                  <div className="sm:w-2/5 p-4 flex items-center justify-center bg-gradient-to-br from-red-100 to-green-100">
                    <img 
                  ...
                  <div className="sm:w-3/5 p-4 flex flex-col justify-center">
                    <Badge className="w-fit mb-2 bg-red-500 text-white">🎄 Holiday Special</Badge>
                    <h3 className="text-lg font-bold text-slate-800 mb-1">Holiday Edition</h3>
                    <p className="text-sm text-slate-600 mb-3">4 C's of Christianity - Perfect for the season!</p>
                    <div className="text-xl font-bold text-red-600 mb-3">$39.99</div>
                    <Button
                      onClick={() => {
                        addToCart({
                          id: 'holiday-special',
                          name: 'Holiday Edition - Adult',
                          price: 39.99,
                          quantity: 1,
                          image: '/covers/holiday-adult-front.jpg'
                        });
                        toast.success('Holiday Edition added to cart!');
                      }}
            ...
            {/* Free Lesson Widget */}
            <Card className="bg-gradient-to-br from-purple-50 to-blue-50 border-2 border-purple-200 shadow-lg hover:shadow-xl transition-shadow overflow-hidden">
              <CardContent className="p-0">
                <div className="flex flex-col sm:flex-row">
                  <div className="sm:w-2/5 p-4 flex items-center justify-center bg-gradient-to-br from-purple-100 to-blue-100">
                    <div className="w-24 h-36 bg-white rounded-lg shadow-md flex items-center justify-center border-2 border-purple-200">
                      <div className="text-center">
                        <div className="text-4xl mb-1">🎁</div>
                        <div className="text-xs font-bold text-purple-600">FREE</div>
                        <div className="text-xs text-slate-600">Sample</div>
                      </div>
                    </div>
                  </div>
                  <div className="sm:w-3/5 p-4 flex flex-col justify-center">
                    <Badge className="w-fit mb-2 bg-purple-500 text-white">✨ Try Before You Buy</Badge>
                    <h3 className="text-lg font-bold text-slate-800 mb-1">Free Sample Lesson</h3>
                    <p className="text-sm text-slate-600 mb-3">Experience a Nibble from our Break*fast Series!</p>
                    <div className="text-xl font-bold text-purple-600 mb-3">FREE</div>
                    <Button
                      onClick={() => window.location.href = '/#free-sample'}
        ...
        <section className="mb-10">
          <Card className="bg-gradient-to-r from-red-600 via-green-600 to-red-600 text-white shadow-xl overflow-hidden">
            <CardContent className="py-4 px-6">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  <span className="text-3xl">🎄</span>
                  <div>
                    <h3 className="text-lg font-bold">Holiday Box Set Special!</h3>
                    <p className="text-sm opacity-90">Get Holiday + Break*fast Series with FREE Bookmark</p>
                  </div>
                </div>
                <Button
                  onClick={() => {
                    addToCart({
                      id: 'holiday-box-set-special',
                      name: 'Holiday Box Set (Holiday + Break*fast)',
                      price: 39.99,
                      quantity: 1,
                      image: '/covers/holiday-adult-front.jpg'
                    });
                    toast.success('Holiday Box Set added to cart!');
                  }}
