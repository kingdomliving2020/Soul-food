...
const FEATURED = [
  ...
  { name: 'Small Group Bundle', img: '/covers/tile-smallgroup.png?v=trio2026', imgClass: 'object-contain p-1.5', tag: 'NEW · 1 IE + 4 Seats' },
            ...
            >
              <div className="aspect-square bg-white rounded-lg overflow-hidden mb-2 border border-slate-100">
                <img
                  src={p.img}
                  alt={p.name}
                  className={`w-full h-full ${p.imgClass || 'object-cover'} group-hover:scale-105 transition-transform`}
                />
              </div>
