...
async def get_orders_list(
    ...
    for tx in txns:
        items.append({
            ...
            "fulfillment_status": tx.get("fulfillment_status", ""),
            "fulfillment_verification_failures": tx.get("fulfillment_verification_failures") or [],
            "downloads_count": tx.get("downloads_count", 0),
            "download_links_generated": tx.get("download_links_generated", False),
            "items": tx.get("items", []),
            "items_count": len(tx.get("items", [])),
